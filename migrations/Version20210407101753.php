 ...
 */
final class Version20210407101753 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE xp (id INT AUTO_INCREMENT NOT NULL, user_id_id INT NOT NULL, job_date_from DATE NOT NULL, job_date_to DATE NOT NULL, job_name VARCHAR(255) NOT NULL, job_location VARCHAR(255) NOT NULL, job_description LONGTEXT NOT NULL, INDEX IDX_F63A903D9D86650F (user_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE phone phone VARCHAR(11) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`');
    }
}
